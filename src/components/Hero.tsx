      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-10 grid grid-cols-3 gap-2 max-w-xl mx-auto">
            {/* Live Support Card */}
            <div 
              className="rounded-lg p-3 backdrop-blur-sm transition-all duration-500 bg-gradient-to-br from-minecraft-primary/15 to-minecraft-secondary/15 bg-black/50 border border-white/10 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(94,66,227,0.2)] animate-fade-up [animation-delay:700ms]"
            ...
            >
              ...
              <div className="text-xl font-bold mb-0 bg-gradient-to-r from-minecraft-primary to-minecraft-secondary bg-clip-text text-transparent">24/7</div>
              <div className="text-xs text-gray-300">Expert help</div>
            </div>
            
            {/* Hardware Performance Card */}
            <div 
              className="rounded-lg p-3 backdrop-blur-sm transition-all duration-500 bg-gradient-to-br from-minecraft-secondary/15 to-minecraft-primary/15 bg-black/50 border border-white/10 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(94,66,227,0.2)] animate-fade-up [animation-delay:800ms]"
              style={{ boxShadow: '0 0 10px rgba(94, 66, 227, 0.1)' }}
            >
              <div className="flex justify-center mb-1">
              ...
              <div className="text-xl font-bold mb-0 bg-gradient-to-r from-minecraft-secondary to-minecraft-primary bg-clip-text text-transparent">Pro</div>
              <div className="text-xs text-gray-300">Top tier</div>
            </div>
            
            {/* Server Location Card - Updated with Indian Flag */}
            <div 
              className="rounded-lg p-3 backdrop-blur-sm transition-all duration-500 bg-gradient-to-br from-minecraft-primary/15 to-minecraft-secondary/15 bg-black/50 border border-white/10 hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(94,66,227,0.2)] animate-fade-up [animation-delay:900ms]"
              style={{ boxShadow: '0 0 10px rgba(94, 66, 227, 0.1)' }}
            >
              <div className="flex justify-center mb-1">
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-minecraft-primary/30 to-minecraft-secondary/30 flex items-center justify-center">
              ...
              <div className="text-xl font-bold mb-0 bg-gradient-to-r from-minecraft-primary to-minecraft-secondary bg-clip-text text-transparent">India</div>
